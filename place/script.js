...
function OddEvenGame() {
  ...
  console.log(queryString, params.get("GAMEPOINT"));
  const player1 = {
    name: params.get("name") || RandomName(),
    point: parseInt(params.get("GAMEPOINT") || GAMEPOINT),
  ...
  document.getElementById("profile").src = player1.url || "./imgs/profile.png";
  game.join();
  ...
  // '
  document.getElementById(ID_OPPONENT_POINT).innerText =
    params.get("GAMEPOINT");
  document.getElementById(ID_MY_POINT).innerText = params.get("GAMEPOINT");
